...
# Interpretation #
# As change in life expectancy increases, change in Health
# Adjusted Life Expectancy (HALE) increases. This does not mean
# that people get healthier as they live longer. This indicates
# that as life expectancy increases, the amount of time spent in
# ill health can either increase or decrease.
